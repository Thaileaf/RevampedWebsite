...
export const metadata: Metadata = {
  title: "Thaison Le's - Software Engineer",
  description: "Software engineer with hands-on experience in full-stack development, cloud infrastructure, and systems administration",
  icons: {
    icon: [
